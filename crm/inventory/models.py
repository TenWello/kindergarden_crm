...
class Inventory(models.Model):
    ...
    delivery_at = models.DateField(verbose_name="Keltirilgan sana", default=timezone.now)
    note = models.CharField(max_length=255, null=True, blank=True, verbose_name="Izoh")
